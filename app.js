...
app.put("/v1/editRequests/:id", editRequests);
...
app.get("/v1/friendRequestsByUser/:id", checkAuth, friendRequestsByUser);
app.get("/v1/getNotificationByUser/:id", checkAuth, getNotificationByUser);
